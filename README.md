...
```bash
docker build -t waleedhammam/gridproxy .
docker run --name ellol -e TWIN=7 -e SERVER_IP="0.0.0.0:8080" -e EXPLORER_URL="https://explorer.devnet.grid.tf/graphql/" -e REDIS_URL="localhost:6379" --cap-add=NET_ADMIN waleedhammam/gridproxy
```
