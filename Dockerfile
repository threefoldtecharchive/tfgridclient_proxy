...
RUN wget https://github.com/threefoldtech/tfgridclient_proxy/releases/download/v1.6.5/tfgridclient_proxy_1.6.5_linux_amd64.tar.gz \
    && tar -xzf tfgridclient_proxy_1.6.5_linux_amd64.tar.gz \
    && chmod +x server \
