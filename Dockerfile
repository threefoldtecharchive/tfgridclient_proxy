...
RUN wget https://github.com/threefoldtech/go-rmb/releases/download/v0.1.10/msgbusd.zip && \
    unzip msgbusd.zip &&\
...
RUN wget https://github.com/threefoldtech/tfgridclient_proxy/releases/download/1.5.1/server -O server \
    && chmod +x server \
