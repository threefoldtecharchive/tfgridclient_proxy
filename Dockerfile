...
RUN wget https://github.com/threefoldtech/tfgridclient_proxy/releases/download/v1.5.7/tfgridclient_proxy_1.5.7_linux_amd64.tar.gz \
    && tar -xzf tfgridclient_proxy_1.5.7_linux_amd64.tar.gz \
    && chmod +x server \
