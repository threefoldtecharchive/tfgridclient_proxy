...
RUN wget https://github.com/threefoldtech/tfgridclient_proxy/releases/download/v1.6.10/tfgridclient_proxy_1.6.10_linux_amd64.tar.gz \
    && tar -xzf tfgridclient_proxy_1.6.10_linux_amd64.tar.gz \
    && chmod +x server \
